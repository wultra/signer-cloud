...
| signer-cloud.server.pades.hash-algorithm                                | `SHA256`           | Algorithm used to compute the hash of the document for signing. Any value of [DigestAlgorithm](https://ec.europa.eu/digital-building-blocks/DSS/webapp-demo/apidocs/eu/europa/esig/dss/enumerations/DigestAlgorithm.html#enum-constant-summary)                                        |
| signer-cloud.server.pades.signature-algorithm                           | `ECDSA_SHA256`     | The algorithm used to sign the document. Any value of [SignatureAlgorithm](https://ec.europa.eu/digital-building-blocks/DSS/webapp-demo/apidocs/eu/europa/esig/dss/enumerations/SignatureAlgorithm.html). The digest algorithm must match `signer-cloud.server.pades.hash-algorithm`.  |
